...
import { ContactButton, ContactNavbar, RightArrow } from '../home/style'
...
function Contact() {
  return (
    <div>
      ...
      <div className="contact-us" style={{marginTop: "400px", display: "flex", flexDirection: "column", alignItems: "center"}}>
        <div>
